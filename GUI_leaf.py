...
# label_dict = {0: 'Bacterial blight', 1: 'Brown Spot', 2: 'Copper Phytotoxicity', 3: 'Downy mildew', 4: 'Healthy', 5: 'Powdery mildew', 6: 'Powdery mildew and Rust', 7:'Rust and target spot', 8: 'Southern blight', 9: 'Soybean Mosaic Virus'}
...
# # Make prediction
# predicted_label = predict_single_image(new_image_path)

# if predicted_label is not None:
#     print(f"The predicted label for the given image is: {predicted_label}")
# else:
#     print("Prediction failed. Please check the new image.")
